                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="editproduct" method="post" id="form1">
                                    ...
                                    <div class="row content-body">
                                        ...
                                        <div class="col-md-9 content-right">
                                            <input type="text" name="name" value="${p.getName()}" placeholder="Enter name" required />
                                        </div>
                                    </div>
                                    <div class="row content-body">
                                        <div class="col-md-3 content-left">
                                        ...
                                        <div class="col-md-9 content-right">
                                            <select id="category" name="categoryId" class="form-select">
                                                <c:forEach items="${categoryList}" var="category">
                                                    <option ${p.getCategory().getId() == category.getId() ? "selected" : ""} value="${category.getId()}">${category.getName()}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 content-right">
                                            <select id="brand" name="brandId" class="form-select">
                                                <c:forEach items="${brandList}" var="brand">
                                                    <option ${p.getBrand().getId() == brand.getId() ? "selected" : ""} value="${brand.getId()}">${brand.getName()}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row content-body">
                                        ...
                                        <div class="col-md-9 content-right">
                                            <textarea rows="4" name="description" required>${p.getDescription()}</textarea>
                                        </div>
                                    </div>
                                    <div class="row content-body">
                                        <div class="col-md-3 content-left">
                                        ...
                                        <div class="col-md-9 content-right">
                                            <textarea rows="4" name="specification" required>${p.getSpecification()}</textarea>
                                        </div>
                                    </div>
                                    <div class="row content-body">
                                        <div class="col-md-3 content-left">
                                        ...
                                        <div class="col-md-9 content-right">
                                            <input type="number" name="price" value="${p.getPrice1()}" required />
                                        </div>
                                    </div>
                                    <div class="row content-body">
                                        <div class="col-md-3 content-left">
                            ...
                            <div class="content-footer">
                                ...
                                <button type="submit" form="form1" class="btn btn-primary">Update</button>
                            </div>
                    </section>
                </div>
