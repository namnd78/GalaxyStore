...
public class CreateBlogServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            String thumbnail = request.getParameter("cthumbnail");
            String description = request.getParameter("cdescription");
            String content = request.getParameter("ccontent");
            int topicId = Integer.parseInt(request.getParameter("ctopicId"));
            LocalDateTime today = LocalDateTime.now();
            BlogDAO bdao = new BlogDAO();
            bdao.create(title, thumbnail, description, content, today, account.getId(), topicId);
