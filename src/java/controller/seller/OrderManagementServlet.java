...
public class OrderManagementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            for (Order order : orders) {
                if (order.getOrderState().getId() == 1) {
                    ...
                    if (!order.getOrderState().getName().equals(("Received"))) {
                        html += "<button style=\"width: 162px;\" type=\"button\" class=\"btn-info d-flex align-items-center justify-content-center\" data-bs-toggle=\"modal\" data-bs-target=\"#deliverOrder\" onclick=\"DeliverOrder(1," + order.getId() + ")\">\n"
            ...
            request.getRequestDispatcher("pages/seller/ordermanagement.jsp").forward(request, response);
        }
    }
