...
public class BlogDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Blog> relatedBlogs = bdao.getRelatedBlogs(blog);
        List<Comment> comments = cmdao.getCommentByBlog(blogId);
        request.setAttribute("categories", categories);
        request.setAttribute("blog", blog);
        request.setAttribute("path", "blog");
        request.setAttribute("relatedBlogs", relatedBlogs);
        request.getRequestDispatcher("pages/blog/blogdetail.jsp").forward(request, response);
    }
