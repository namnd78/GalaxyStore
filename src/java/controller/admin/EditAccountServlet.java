...
public class EditAccountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Account account = adao.getAccountById(Integer.parseInt(request.getParameter("accountId")));
        ...
        account.setRole(rdao.getRoleById(roleId));
        if (part.getSize() > 0) {
        ...
        adao.update(account);
        session.setAttribute("success", "Edit account successfully!");
