 ...
 * @author Duong
 */
public class HelpusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HelpusServlet</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (listHelp != null) {
            for (Help help : listHelp) {
                html += "<li class=\"nav-item\" id=\"" + help.id + "\" role=\"presentation\">\n"
                        + "                                            <button class=\"nav-link " + help.state + "\" id=\"" + help.tab + "\" data-bs-toggle=\"tab\" data-bs-target=\"" + help.target + "\" type=\"button\" role=\"tab\">" + help.title + "\n"
        ...
        request.getRequestDispatcher("pages/account/help.jsp").forward(request, response);
    }
